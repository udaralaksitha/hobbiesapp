...
const Details = () => {
    ...
    return (
        <div className="container mt-3">
            <h1 style={{ fontWeight: 400 }}>Welcome to Hobbies App</h1>
                ...
                <CardContent>
                    ...
                    <div className="row">
                        <div className="left_view col-lg-6 col-md-6 col-12">
                            ...
                            <h3 className="mt-3">User Name: <span >{getuserdata.name}</span></h3>
                            <p className="mt-3"><MailOutlineIcon />Email: <span>{getuserdata.email}</span></p>
                            <p className="mt-3"><WorkIcon />Hobby Type: <span>{getuserdata.htype}</span></p>
                        </div>
                        <div className="right_view  col-lg-6 col-md-6 col-12">

                            <p className="mt-5"><PhoneAndroidIcon />mobile: <span>+94 {getuserdata.mobile}</span></p>
